...
//    }
    ...
    public void itemUpdate() {
        ...
        assertAll(
                () -> Assertions.assertDoesNotThrow(() -> itemService.updateItem(ownerId, updatedItemDto)),
    ...
    public void getItem() {
        ...
        Assertions.assertEquals(itemService.getItemById(itemId, ownerId).getName(), item.getName());
    }
